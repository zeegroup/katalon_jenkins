...
Mobile.tap(findTestObject('Create_Poll_1/android.widget.TextView0 - NEXT'), 0)

Mobile.tap(findTestObject('Create_Poll_1/android.widget.TextView0 - LOGIN'), 0)

Mobile.setText(findTestObject('Create_Poll_1/android.widget.EditText0 - Email ID'), 'sudheer@mailnesia.com', 0)

Mobile.setText(findTestObject('Create_Poll_1/android.widget.EditText0 - Password'), '1234567', 0)

Mobile.tap(findTestObject('Create_Poll_1/android.widget.ImageButton0'), 0)

Mobile.tap(findTestObject('Create_Poll_1/android.widget.TextView0 - LOGIN (1)'), 0)

Mobile.tap(findTestObject('Create_Poll_1/android.widget.FrameLayout0'), 0)

Mobile.tap(findTestObject('Create_poll/android.widget.TextView0 - Poll'), 0)

Mobile.setText(findTestObject('Create_Poll_1/android.widget.EditText0 - Ask a question.'), 'do u like movies', 
    0)
